...
- 启动wparse：`nohup wparse daemon --stat 10 -p> data/logs/wparse-info.log 2>&1 &`
- 启动发送相关工具：
  - `nohup wpgen sample -c wpgen-kafka.toml --stat 10 -p > data/logs/wpgen-kafka.log 2>&1 &`
  - `nohup wpgen sample -c wpgen-tcp.toml --stat 10 -p > data/logs/wpgen-tcp.log 2>&1 &`
  - `nohup wpgen sample -c wpgen-file.toml --stat 10 -p > data/logs/wpgen-file.log 2>&1 &`
