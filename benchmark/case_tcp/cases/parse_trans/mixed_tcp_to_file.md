...
| :-- | :-- | :-- | :-- | :-- | :-- |
| WarpParse | 120,100 | 101.48 | 648% / 727% | 121 MB / 183 MB | 6.19x |
| Vector-VRL | 19,400 | 16.39 | 268% / 300% | 201 MB / 216 MB | 1.00x |
| Vector-Fixed | 20,000 | 16.90 | 273% / 303% | 195 MB / 207 MB | 1.03x |
| Logstash | 26,666 | 22.53 | 612% / 689% | 1218 MB / 1253 MB | 1.37x |

### macOS (Mac M4 Mini)
| 引擎 | EPS | MPS | CPU (Avg/Peak) | MEM (Avg/Peak) | 性能倍数 |
| :-- | :-- | :-- | :-- | :-- | :-- |
| WarpParse | 299,900 | 253.40 | 616% / 754% | 332 MB / 493 MB | 3.86x |
| Vector-VRL | 77,600 | 65.57 | 397% / 421% | 363 MB / 374 MB | 1.0x |
| Vector-Fixed | 78,100 | 65.99 | 400% / 421% | 337 MB / 358 MB | 1.01x |
| Logstash | 93,153 | 78.71 | 859% / 957% | 1274 MB / 1308 MB | 1.20x |
