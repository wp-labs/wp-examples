...
| :-- | :-- | :-- | :-- | :-- | :-- |
| WarpParse | 259,900 | 101.87 | 682% / 697% | 139 MB / 275 MB | 1.99x |
| Vector-VRL | 130,600 | 51.19 | 446% / 500% | 191 MB / 195 MB | 1.0x |
| Vector-Fixed | 146,000 | 57.23 | 413% / 441% | 181 MB / 184 MB | 1.12x |
| Logstash | 78,125 | 30.62 | 624% / 696% | 1212 MB / 1272 MB | 0.60x |

### macOS (Mac M4 Mini)
| 引擎 | EPS | MPS | CPU (Avg/Peak) | MEM (Avg/Peak) | 性能倍数 |
| :-- | :-- | :-- | :-- | :-- | :-- |
| WarpParse | 757,600 | 296.97 | 714% / 758% | 270 MB / 360 MB | 2.04x |
| Vector-VRL | 370,900 | 145.38 | 561% / 607% | 284 MB / 293 MB | 1.0x |
| Vector-Fixed | 481,700 | 188.81 | 466% / 536% | 265 MB / 272 MB | 1.30x |
| Logstash | 222,222 | 87.10 | 795% / 889% | 1336 MB / 1377 MB | 0.60x |
